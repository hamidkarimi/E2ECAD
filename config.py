...
parser.add_argument("--network_out_size", type=int, required=False, default=30,
...
parser.add_argument("--dropout", type=float, required=False, default=0, help="The dropout")
...
# Use the name of any of these features to mask (either lowercase or uppercase) seperated by ';'
...
parser.add_argument('--gpu', type=str2bool, default='True', help='enables CUDA training')
...
parser.add_argument("--step_size_lr", type=float, required=False, default=150, help="The learning rate decay rate")
